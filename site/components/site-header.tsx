...
export function SiteHeader() {
  return (
    <header className="topbar">
      <Link className="brand" href="/" aria-label="Drift CLI home">
        <span className="brand-mark" aria-hidden="true">
          <img src="/drift-cli-mark.svg" alt="" width={60} height={60} />
        </span>
        <span className="brand-copy">
          <span className="brand-name">Drift CLI</span>
          <span className="brand-tag">Operate Drift with explicit commands</span>
        </span>
      </Link>
      ...
      <div className="topbar-actions">
        ...
        <a
          className="repo-link"
          href={repositoryUrl}
          aria-label="Drift CLI on GitHub"
          target="_blank"
          rel="noreferrer"
        >
